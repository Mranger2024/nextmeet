...
export default function RoomsPanel() {
  ...
  // Add this function to check if a room is expired
  ...
  // Update the handleRoomExpiry function
  const handleRoomExpiry = async (room: Room) => {
    try {
      ...
      console.error('Error handling room expiry:', error.message || 'Unknown error')
    }
  }
  ...
  useEffect(() => {
    ...
    // Periodic check
    checkInterval = setInterval(checkExpiredRooms, 30000)
