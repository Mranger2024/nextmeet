...
export default function ComingSoonPanel({ feature }: ComingSoonPanelProps) {
  return (
    <div className="h-full flex flex-col items-center justify-center p-8 bg-gradient-to-b from-[var(--panel-bg)] to-[var(--panel-bg-secondary)] text-center">
      <motion.div
        ...
        className="mb-6"
      >
        <CalendarClock size={64} className="text-[var(--text-primary)]" />
      </motion.div>
