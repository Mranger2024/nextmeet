...
import { Users, Brain, Heart, Sparkles, Globe, Filter } from 'lucide-react'
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mb-4">
                      &ldquo;We&#39;ll find your perfect match&rdquo; I was skeptical about AI matching at first, but NextMeet connected me with people who share my passion for photography. I&#39;ve made friends from around the world who give me feedback on my work!
                    </p>
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((star) => (
              ...
              <div className="bg-gray-800/30 rounded-xl p-6 border border-gray-700/50">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mb-4">
                      &ldquo;We&#39;re not just another dating app&rdquo; As a language learner, I wanted to practice with native speakers. NextMeet&#39;s smart matching found me perfect conversation partners who were patient and helpful with my Spanish practice.
                    </p>
                    <div className="flex">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <svg key={star} className="w-5 h-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
