...
const typingAnimation = '/animations/typing-animation.json'
...
const AIChatbotPanel = () => {
  ...
  const [animationState, setAnimationState] = useState<'welcome' | 'idle' | 'typing' | 'listening' | 'error'>('welcome')
  ...
  const renderAnimation = () => {
    if (!isAnimationsLoaded) return null

    return (
      <div className="w-16 h-16 mx-auto mb-4">
        <LottieWrapper
          animationPath={
            animationState === 'welcome' ? welcomeAnimation :
            animationState === 'typing' ? typingAnimation : idleAnimation
          }
