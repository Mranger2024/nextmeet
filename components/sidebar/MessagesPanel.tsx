...
interface MessagesPanelProps {
  ...
  setSelectedChat: React.Dispatch<React.SetStateAction<{ id: string; name: string; participants: any[]; is_group: boolean; created_at: string; } | null>>;
}

export default function MessagesPanel({ selectedChat, setSelectedChat }: MessagesPanelProps) {
